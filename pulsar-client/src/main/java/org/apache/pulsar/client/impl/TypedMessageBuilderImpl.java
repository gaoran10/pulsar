...
public class TypedMessageBuilderImpl<T> implements TypedMessageBuilder<T> {
    ...
    private transient byte[] schemaId;
    ...
    private long beforeSend() {
        if (value == null) {
            ...
            getKeyValueSchema().map(keyValueSchema -> {
                ...
                schemaId = encodeData.getSchemaData();
                return this;
            });
        }
    ...
    private <K, V> void setSeparateKeyValue(T value, KeyValueSchema<K, V> keyValueSchema) {
        ...
        msgMetadata.setSchemaId(KeyValue.generateKVSchemaId(
                keyEncoded == null ? null : keyEncoded.getSchemaData(),
                valueEncoded == null ? null : valueEncoded.getSchemaData()));
    }
}
